#!/bin/bash
#
# rayavg: generate field-dump averages along rays in the
# dx,dy-direction emanating from an x-y line. It is assumed that the
# z-direction variations have already been discarded using project
# -z1.  The field-dump should be in binary format (the default).
#
