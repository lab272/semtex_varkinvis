...
// subsequently, the correct system is selected based on process ID and
// coordinats system choice.)
//
///////////////////////////////////////////////////////////////////////////////
...
NumberSys::NumberSys (const vector<AssemblyMap*>& allMaps,
		      const char                  name   ) : 
// ---------------------------------------------------------------------------
// Construct vectors of modal assembly map systems for all modes of a
// named field.  Input value "name" is one of the standard Field
// names: "uvwcp". On entry, the numbering schemes for all fields and
// modes are available in input variable allMaps.
// ---------------------------------------------------------------------------
  _field_name (name)
{
