...
// ---------------------------------------------------------------------------
{
  ...
  if (!strstr (s, "binary"))
    Veclib::messg (routine, "input field file not in binary format", ERROR);
...
// ---------------------------------------------------------------------------
{
  ...
  if (i != nSlice)
    Veclib::messg (routine, "mismatch: No. of base slices/declaration", ERROR);
