...
speed-up will be intially somewhat linear with number of processors
...
variable.  It is now only possible to apply the forcing uinformly in
physical space.
...
This is the treatment of Boussinesq buoyancy decribed in
...
arbitarily accelarating and rotating frame of reference.  As in our
...
has frame accerelation in the $-x$ direction, which is equivalent to a
...
which genarated an assembly map or numbering file that the executables
read in.
%
{\small
\begin{verbatim}
