...
earlier.  To see all the predefined \verb|TOKENS| and functions, run
the \Semtex\ utility \verb|"calc -h"|.
...
%
As we will elaborate below, the string \verb|axis| is also significant
to the solver if cylindrical coordinates are chosen.
