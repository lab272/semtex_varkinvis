...
attempting to converge a solution (it is a $hp$-type method).  The
basis polynomials share convergence properties with (orthogonal)
Legendre polynomials and the underlying goal of mesh refinement is to
...
commence exponential convergence.  A few iterations of mesh design may
be required when tackling a new problem.
%
