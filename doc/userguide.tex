...
%session file, so in this case it is called \verb|laplace7.num|.  If
...
approach than the standard method.  As outlined in
\citeauthor{blss21}, a gravitational field $\bm{g}$ would be included
as a frame acceleration term $\bm{A}\equiv-\bm{g}$ and dealt with
using the approach described in \S\,\ref{sec.constant}.  Any
frame-rotation terms would be dealt with as described in
\S\,\ref{sec.rotating}.
