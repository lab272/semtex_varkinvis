...
Here is how to use \verb|dns_mp| for that problem (noting that one
should first have used \verb|enumerate| to generate a
\verb|chan.num| file) with 8 processors: {\small
\begin{verbatim}
